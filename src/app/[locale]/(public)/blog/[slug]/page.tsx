            ...
            <article className="py-12 px-4">
                <div className="container mx-auto max-w-4xl">
                    ...
                    <header className="mb-10 text-center">
                        ...
                        <h1 className="text-3xl md:text-5xl font-black text-gray-900 mb-6 leading-tight break-words">
                            {title}
                        </h1>
                    ...
                    {/* Content */}
                    <div className="bg-white dark:bg-zinc-900 rounded-3xl p-8 md:p-12 border border-gray-100 dark:border-zinc-800 shadow-xl shadow-gray-200/50 dark:shadow-none overflow-hidden">
                        <div
                            className="prose prose-orange prose-lg max-w-none dark:prose-invert break-words"
